...
var formLogout = document.querySelector("#logout")
...
function events(){
    ...
    if (formLogout)
        formLogout.addEventListener("click", function(e){
            logout(e)
        });  
    if (formNew)
        formNew.addEventListener("submit", function(e){
            ...
            <div class=" "  >
                <div class="card"  data-id="${ i.id }" >
                    <div class="card-body">
                        ...
                        <p class="card-text">Descripcion: <span> ${ i.description } </span></p>
                        <div class="action">
